...
import uz.elmurod.main.databinding.FragmentSportsBinding

@AndroidEntryPoint
class SportsFragment : BaseFragment(R.layout.fragment_sports) {
    private val binding: FragmentSportsBinding by viewBinding(FragmentSportsBinding::bind)
    ...
    override fun setup() {
        ...
        lifecycleScope.launchWhenResumed {
            binding.recyclerSports.setHasFixedSize(true)
            ...
            adapter.addLoadStateListener { loadState ->
                binding.apply {
                    ...
                    recyclerSports.isVisible = loadState.source.refresh is LoadState.Loading
                    ...
                    if (loadState.source.refresh is LoadState.NotLoading &&
                        ...
                        recyclerSports.isVisible = false
                        tvNotFound.isVisible = true

                    } else {
                        recyclerSports.isVisible = true
