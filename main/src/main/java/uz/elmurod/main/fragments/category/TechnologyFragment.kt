...
import uz.elmurod.main.databinding.FragmentTechnologyBinding

@AndroidEntryPoint
class TechnologyFragment : BaseFragment(R.layout.fragment_technology) {
    private val binding: FragmentTechnologyBinding by viewBinding(FragmentTechnologyBinding::bind)
    ...
    override fun setup() {
        ...
        lifecycleScope.launchWhenResumed {
            binding.recyclerTechnology.setHasFixedSize(true)
            binding.recyclerTechnology.adapter = adapter.withLoadStateHeaderAndFooter(
            ...
            adapter.addLoadStateListener { loadState ->
                binding.apply {
                    ...
                    recyclerTechnology.isVisible = loadState.source.refresh is LoadState.Loading
                    ...
                    if (loadState.source.refresh is LoadState.NotLoading &&
                        ...
                        recyclerTechnology.isVisible = false
                        tvNotFound.isVisible = true

                    } else {
                        tvNotFound.isVisible = false
                        recyclerTechnology.isVisible = true

                    }
                }
            }
            viewModel.getNewsCategory("technology")
