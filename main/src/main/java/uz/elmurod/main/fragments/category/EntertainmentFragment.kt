...
import uz.elmurod.main.databinding.FragmentEntertainBinding

@AndroidEntryPoint
class EntertainmentFragment : BaseFragment(R.layout.fragment_entertain) {
    private val binding: FragmentEntertainBinding by viewBinding(FragmentEntertainBinding::bind)
    ...
    override fun setup() {
        ...
        lifecycleScope.launchWhenResumed {
            binding.recyclerEntertain.setHasFixedSize(true)
            binding.recyclerEntertain.adapter = adapter.withLoadStateHeaderAndFooter(
            ...
            adapter.addLoadStateListener { loadState ->
                binding.apply {
                    ...
                    recyclerEntertain.isVisible = loadState.source.refresh is LoadState.Loading
                    ...
                    if (loadState.source.refresh is LoadState.NotLoading &&
                        ...
                        recyclerEntertain.isVisible = false
                        tvNotFound.isVisible = true

                    } else {
                        recyclerEntertain.isVisible = true
            ...
            viewModel.getNewsCategory("entertainment")
